...
model = FER_Model(
    "../Models\model_layer-4_Conv/Model_Conv4_layer.json",
    "../Models/model_layer-4_Conv/ModelWeight_Conv4_layer.h5",
)
...
class FER_Video(object):
    ...
    def get_frame(self):
        ...
        for x, y, w, h in faces:
            ...
            cv2.rectangle(fr, (x, y), (x + w, y + h + 10), (255, 0, 0), 4)
...
Test_video = "../Videos/expression_test.mp4"
Emotion_Detector(FER_Video(Test_video))
